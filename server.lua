...
RegisterServerEvent('tra_tv:add')
AddEventHandler('tra_tv:add', function(url, object, coords, scale, offset)
    ...
    TriggerClientEvent('tra_tv:update', -1, tosend)
end)

RegisterServerEvent('tra_tv:fetch')
AddEventHandler('tra_tv:fetch', function()
    local tosend = {}
    ...
    TriggerClientEvent('tra_tv:update', source, tosend)
end)

RegisterServerEvent('tra_tv:setvolume')
AddEventHandler('tra_tv:setvolume', function(id, volume)
    if volume >= 0 and volume <= 10 then
        if data[id] then

            data[id]['Volume'] = volume

            TriggerClientEvent('tra_tv:updatevolume', -1, id, volume)

        end
    end
end)

RegisterServerEvent('tra_tv:destroy')
AddEventHandler('tra_tv:destroy', function(id)
    if data[id] then
        data[id] = nil
        TriggerClientEvent('tra_tv:delete', -1, id)
    end
end)